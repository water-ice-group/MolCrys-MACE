...
mace = MACECalculator('/scratch/snx3000/fdellapi/MolCrys/X23_VASP/models/full_qne/models/REPULSION-2/01_cyclohexanedione/MACE_model_swa.model', default_dtype='float64',device='cuda')
atoms.calc = mace


e  = []
delta = 0.004 # displacement
for T1 in np.arange(10,310,10): # list of temperatures
