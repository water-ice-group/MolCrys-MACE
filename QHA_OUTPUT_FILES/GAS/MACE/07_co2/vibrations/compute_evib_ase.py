...
def get_vib_gas(atoms,delta,T):
    ...
    dof =  3*a - 5
    threshold = 0.1 / 1000 # threshold in eV
    harm = 0
    harm_full = 0
    n = 0
...
atoms = read('POSCAR')
mace = MACECalculator('/scratch/snx3000/fdellapi/MolCrys/X23_VASP/models/full_qne/models/REPULSION-2/07_co2/MACE_model_swa.model', default_dtype='float64',device='cuda')
atoms.calc = mace
