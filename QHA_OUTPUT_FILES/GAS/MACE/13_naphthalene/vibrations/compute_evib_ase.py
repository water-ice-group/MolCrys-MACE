...
atoms = read('POSCAR')
mace = MACECalculator('/scratch/snx3000/fdellapi/MolCrys/X23_VASP/models/full_qne/models/REPULSION-2/13_naphthalene/MACE_model_swa.model', default_dtype='float64',device='cuda')
atoms.calc = mace
