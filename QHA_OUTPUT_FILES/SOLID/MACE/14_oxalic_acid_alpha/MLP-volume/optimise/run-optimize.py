...
path_to_model='/scratch/snx3000/fdellapi/MolCrys/X23_VASP/models/full_qne/models/REPULSION-2/14_oxalic_acid_alpha'
...
ucf = UnitCellFilter(atoms, scalar_pressure=0)
